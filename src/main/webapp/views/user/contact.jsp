				...
				<div class="col-12">
					<nav class="main-nav">
						...
						<a href="<c:url value='/views/user/index.jsp'/>" class="logo">
							...
							alt="Logo" style="width: 158px;">
						</a>
						<!-- ***** Logo End ***** -->
						<!-- ***** Menu Start ***** -->
						<ul class="nav">
							<li><a href="<c:url value='/views/user/index.jsp'/>">Trang
									Chủ</a></li>
							<li><a href="s<c:url value='/views/user/hop.jsp'/>">Cửa
									Hàng</a></li>
							<li><a href="<c:url value='/views/user/gioihieu.jsp'/>">Giới
									hiệu</a></li>
							<li><a href="<c:url value='/views/user/contact.jsp'/>"
								class="active">Liên Hệ</a></li>
							<li><a href="history.jsp'/>">lịch sử mua hàng</a></li>
							<li><a href="<c:url value='/views/user/login.jsp'/>">Đăng
									Nhập</a></li>
						</ul>
			...
			<div class="row">
				<div class="col-lg-6 align-self-center">
					<div class="left-text">
						...
						<p>Gong Cha luôn mong muốn nhận được nhưng phản hồi quý giá
							của quý khách hàng để có cơ hội hoàn thiện sản phẩm, dịch vụ hơn
							nữa. Những đóng góp của quý khách hàng luôn là tài sản vô giá đối
							với chúng tôi. Cảm ơn bạn!</p>
						<ul>
							<li><span>Địa Chỉ</span> số 79 Hồ Tùng Mậu, Quận 1, Thành
								Phố Hồ Chí Minh</li>
										...
										<div class="col-lg-6">
											<fieldset>
												<input type="text" name="name" id="name"
													placeholder="Tên của bạn..." autocomplete="on" required>
											</fieldset>
										</div>
										<div class="col-lg-6">
											<fieldset>
												<input type="text" name="surname" id="surname"
													placeholder="Họ của bạn..." autocomplete="on" required>
											</fieldset>
										</div>
										<div class="col-lg-6">
											<fieldset>
										...
										<div class="col-lg-6">
											<fieldset>
												<input type="text" name="subject" id="subject"
													placeholder="Chủ đề phản hồi..." autocomplete="on" required>
											</fieldset>
										</div>
										<div class="col-lg-12">
											<fieldset>
			...
			<div class="row no-gutters">
				<div class="col-md-6 left-footer">
					<div class="footer-logo text-center">
						<img
							src="<c:url value='/template/user/assets/images/Gongcha-Logo-1.png'/>"
							alt="Gong Cha Logo" style="width: 150px;">
					</div>
